...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Register Customer', component: RegisterCustomer},
      { title: 'Register Plan', component: RegisterPlan},
      { title: 'Customer List', component: CustomerListPage },
      { title: 'Plan List', component: PlanListPage}
    ];
